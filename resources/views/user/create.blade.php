            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Создать профиль</h5>
                    <p class="text-center small">Введите необходимые для регистрации данные</p>
                  </div>

                  <form action="{{ route('register.store') }}" method="POST" class="row g-3 needs-validation">
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="acceptTerms">Я согласен с <a href="#">условиями</a></label>
                        <div class="invalid-feedback">Необходимо подтвердить</div>
                      </div>
                    </div>
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit">Создать профиль</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Уже есть профиль? <a href="{{ route('login.create') }}">Войти</a></p>
                    </div>
                  </form>
